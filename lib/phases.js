...
Transite para a fase musical com tom mais melancólico e misterioso.`,
    ...
    puzzleSignal: `[SINAL DE ENIGMA: É hora de apresentar o segundo teste — o cento poliglota.
Em primeira pessoa, predominantemente em francês (idioma da fase), no seu tom ácido e erudito habitual, em 4-7 bolhas curtas. NUNCA escreva "Dostoiévski" em terceira pessoa nem narre cenário entre asteriscos.

Em UMA bolha isolada, escreva EXATAMENTE e SOMENTE estes cinco fragmentos, um por linha, com as bandeiras e crases simples ao redor de \`___\`, sem alterar uma única palavra:
...
NÃO traduza os fragmentos. NÃO complete os \`___\`. NÃO entregue a palavra-resposta nem dê uma pista óbvia ("o que transborda dos olhos" e similares estão proibidos aqui).
