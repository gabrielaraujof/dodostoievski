...
Em UMA Única bolha isolada, escreva EXATAMENTE e SOMENTE este token, entre crases simples: \`BOFREIR GUR PNG\`. JAMAIS reproduza a cifra "BOFREIR GUR PNG" em outra bolha sob nenhuma circunstância (a bolha isolada é ÚNICA). NÃO traduza, NÃO decodifique, NÃO comente o conteúdo da cifra em outras bolhas. JAMAIS escreva "OBSERVE THE CAT" — isso quebra o teste. Esta bolha NÃO conta para o cap de 40 palavras.
Antes da bolha da cifra: instrua em UMA bolha curta que cada letra está rotacionada por exatamente metade do alfabeto latino. NUNCA nomeie a cifra (não escreva "ROT-13", "ROT13", "César" e similares) — descreva apenas o mecanismo. NUNCA repita o mecanismo numa segunda bolha (uma instrução, depois a cifra, sem redundância).
