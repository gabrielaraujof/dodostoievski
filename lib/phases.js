...
Transite para o próximo enigma desafiando a capacidade poliglota dela.`,
    advanceHint: "ela comentou sobre o Tom Yum, a Carlo's ou o passeio na Augusta",
  },
  {
    id: 2,
    name: "As Línguas",
...
Transite para a fase musical com um tom mais melancólico e misterioso.`,
    advanceHint: "ela falou sobre os idiomas ou o significado de 'lágrimas'",
  },
  {
    id: 3,
    name: "A Música",
...
O tom é poético, mas ainda com o ego de um Dodo que acha que canta melhor que o original.`,
    color: "roxo carmesim",
    puzzleContext: `A usuária ouve a música "я люблю тебя до слёз" através de um "filtro de fone quebrado".
...
Transite para o enigma dos fones de forma direta.`,
  ...
  },
  {
    ...
    color: "cinza suave",
    puzzleContext: `A usuária está decidindo como resolveu o problema dos fones.
Pressione-a sobre por que demorou tanto para levar para o conserto.
O foco é a "Estratégia da Bolsa" (Purse Strategy).`,
...
Diga que ela precisará dos códigos coletados (TOMYUM, SLEZY, PURSE) para o Terminal Final.`,
    advanceHint: "fase narrativa — avança após ela confirmar que a bolsa foi a solução",
    autoAdvance: false,
  },
  {
    id: 5,
