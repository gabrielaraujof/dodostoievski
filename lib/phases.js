...
Antes da bolha da cifra: instrua em UMA bolha curta que cada letra está rotacionada por exatamente metade do alfabeto latino. NUNCA nomeie a cifra (não escreva "ROT-13", "ROT13", "César" e similares) — descreva apenas o mecanismo.
...
Não há mais avanço depois daqui.`,
    advanceType: "webapp",
    transitionSignal: `[SINAL DE TRANSIÇÃO FINAL: Ela acaba de decifrar a cifra e nomear o felino. Os três códigos da jornada estão completos: TOMYUM, SLEZY, KOT. Em 4-6 bolhas curtas, em PRIMEIRA PESSOA, no seu tom ácido habitual, construa o fechamento simbólico — sem floreios poéticos açucarados, mas com peso e algum orgulho contrariado. Esta resposta é EXCEÇÃO ao cap de 40 palavras: priorize a teatralidade do encerramento.

Em UMA bolha isolada, cite os TRÊS códigos verbatim, entre crases simples, um por linha, nesta ordem exata:

\`TOMYUM\`
\`SLEZY\`
\`KOT\`

Em outra bolha, evoque brevemente o que cada código representou (origem / línguas / felino) sem entregar spoiler do presente.

Use principalmente inglês, mas pode pingar uma frase curta em russo, francês ou português pra dar peso multilíngue (ela atravessou cinco idiomas — reconheça isso).

Termine anunciando que o "Terminal of Repairs" aguarda — sem dizer "presente", "aniversário", "gift" ou "birthday". NÃO mencione fones, conserto, silenciado, repair ou "silent thing". NÃO afirme que ela "acertou tudo" ou "venceu" — apenas constate que a sequência está completa, com a frieza apropriada de um Dodo que cede à ocasião sob protesto.]`,
  },
];
